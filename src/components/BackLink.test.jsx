...
describe('BackLink', () => {
  ...
  it('renders back link with default text and arrow', () => {
    ...
    expect(screen.getByRole('button', { name: 'Go back to previous question' })).toBeInTheDocument();
  ...
  it('calls onClick when clicked', () => {
    ...
    const backButton = screen.getByRole('button', { name: 'Go back to previous question' });
  ...
  it('applies disabled styling when disabled', () => {
    ...
    const backLink = screen.getByRole('button', { name: 'Go back to previous question' });
  ...
  it('uses custom aria label when provided', () => {
    ...
    expect(screen.getByRole('button', { name: 'Return to previous step' })).toBeInTheDocument();
  });
  ...
  it('has correct accessibility attributes', () => {
    ...
    expect(backLink).toHaveAttribute('aria-label', 'Go back to previous question');
  });
